...
Un prototype dynamique de l'application est disponible a l'adresse suivante : \url{https://github.com/xeph/LOG350.TP3}.
...
\begin{table}
	...
	\begin{tabular}{|l|l|l|}
	\hline
	no Tache	& Points importants de l'observation de A	& Points importants de l'observation de B 	\\ \hline
	0		& 0						& 0 						\\ \hline
	\end{tabular}
\end{table}
